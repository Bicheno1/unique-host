...
# The activation count is global — if adrenaline shows up 3 times → x3.
...
CONCEPTS = {
    ...
    "person": {
        ...
        "type":     "subject",
        "subtype":  "person",
        "synonyms": ["human", "someone", "somebody"],
        "related": {
    ...
    "room": {
        ...
        "related": {
            ...
            "enclosed":     {"somatic": ["closed_space"],                 "mental": ["anticipation", "loneliness"]},
    ...
    "dark": {
        ...
        "type":     "environment",
        "subtype":  "condition",
        "synonyms": ["darkness", "darkness", "dim"],
        "related": {
    ...
    "place": {
        ...
        "synonyms": ["spot", "site"],
        "related": {
            "enclosed":     {"somatic": ["closed_space"],                 "mental": ["anticipation"]},
            "isolated":     {"somatic": ["isolation"],                     "mental": ["loneliness"]},
        }
    },
    ...
    "melody": {
        ...
        "synonyms": ["melody", "tune", "song", "music", "beautiful_song"],
        "related": {
...
"person": {
    ...
    "urgent_tone": {
        ...
        "type":     "language",
        "subtype":  "voice_tone",
        "synonyms": ["urgent", "alarmed", "alarmed"],
        "related": {
    ...
    "which": {
        ...
        "synonyms": ["what", "which", "what-is", "what"],
        "related": {
    ...
    "aggressive": {
        ...
        "type":     "status",
        "subtype":  "threat",
        "synonyms": ["aggression", "aggressive", "hostile", "violent"],
        "related": {
